	...
	<form action="FrontController" method="post">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" pattern="([A-Za-z]{1})([A-Za-z0-9-_]{5,50})"
					...
					class="form-control" name="login" id="login" value="" required />
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				...
				oninput="setCustomValidity('')"
				class="form-control" name="name" id="name" value="" required />
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-4">
				...
				oninput="setCustomValidity('')"
				class="form-control" name="surname" id="surname" value="" required />
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-4">
				...
				oninput="setCustomValidity('')"
				class="form-control" name="email" id="email" value="" required />
			</div>
		</div>		
		<div class="form-group row">
			...
			<div class="col-sm-4">
				...
				oninput="setCustomValidity('')"
				class="form-control" id="datepicker" name="birthDate" value="" required />
			</div>
		</div>		
		<div class="form-group row">
		...
		<input type="submit" class="btn btn-outline-secondary btn-md" value="${reg_button}" />
